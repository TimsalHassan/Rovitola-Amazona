      ...
      <div className="max-w-[1200px] mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">{t("aboutPage.body1")}</p>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">{t("aboutPage.body2")}</p>
            <div className="flex flex-wrap gap-3">
              <span className="bg-gray-800 border border-white/10 rounded-lg px-4 py-2 flex items-center gap-2 text-sm text-gray-300">
                <Clock size={16} className="text-amber-400" />
                {t("aboutPage.established")}
              </span>
              <span className="bg-gray-800 border border-white/10 rounded-lg px-4 py-2 flex items-center gap-2 text-sm text-gray-300">
                <MapPin size={16} className="text-amber-400" />
                {info?.address ?? t("aboutPage.location")}
              </span>
              <span className="bg-gray-800 border border-white/10 rounded-lg px-4 py-2 flex items-center gap-2 text-sm text-gray-300">
        ...
        {info?.opening_hours && (
          <div className="bg-gray-900 border border-white/5 rounded-2xl p-6 mt-10">
        ...
        <div className="w-fit mx-auto bg-gray-900 border border-white/5 rounded-2xl p-4 mt-10 flex items-center justify-center overflow-hidden">
          <iframe
