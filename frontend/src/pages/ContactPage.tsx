...
const INITIAL_FORM = { name: '', email: '', phone: '', subject: 'general', message: '' };
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-900 border border-white/5 rounded-2xl p-6">
            ...
            {submitted ? (
              <div className="text-center py-10 space-y-4">
                ...
                <p className="text-white font-semibold">{t("contact.messageSentTitle")}</p>
          ...
          <div className="space-y-6">
                ...
                {(info?.phone || info?.phone_2) && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      {info.phone && <a href={`tel:${info.phone}`} className="text-gray-400 hover:text-amber-400 block transition-colors">{info.phone}</a>}
                      {info.phone_2 && <a href={`tel:${info.phone_2}`} className="text-gray-400 hover:text-amber-400 block transition-colors">{info.phone_2}</a>}
                    </div>
                  </div>
                )}
                {info?.email && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${info.email}`} className="text-gray-400 hover:text-amber-400 transition-colors">{info.email}</a>
                    </div>
                  </div>
                )}
              </div>
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                  <p className="text-amber-400 text-xs font-medium">
                    ...
                    {(() => {
                      ...
                      return d ? `${formatTime(d.lunch_open)} – ${formatTime(d.lunch_close)}` : "";
                    })()}
                  </p>
                </div>
              )}
            ...
            <div className="bg-gray-900 border border-white/5 rounded-2xl p-4 h-48 overflow-hidden">
              <iframe
                ...
                width="600" height="450" style={{ border: 0 }} allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer-when-downgrade"
              />
            </div>
          </div>
        </div>
